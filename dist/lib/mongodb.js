...
if (process.env.NODE_ENV === "development") {
    ...
    if (!globalWithMongo._mongoClientPromise) {
        if (!uri) {
            ...
            client = new mongodb_1.MongoClient(uri, Object.assign(Object.assign({}, options), { serverSelectionTimeoutMS: 30000, connectTimeoutMS: 30000, socketTimeoutMS: 45000 }));
...
async function getDb() {
    ...
    const dbName = process.env.DATABASE_NAME || ((_a = uri.split('/').pop()) === null || _a === void 0 ? void 0 : _a.split('?')[0]) || 'devconnect';
