  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 p-4">
      <motion.div
        ...
        className="bg-gray-800/50 backdrop-blur-sm shadow-2xl rounded-2xl p-8 w-full max-w-md border border-gray-700/50"
      >
        {/* Header */}
        ...
        {/* Lock Message */}
        {isLocked && (
          <div className="mb-4 p-3 bg-yellow-500/20 border border-yellow-500/50 rounded-lg text-yellow-400 text-sm flex items-center gap-2">
            <Shield className="h-4 w-4" />
            <span>Account locked. Please wait {Math.floor(lockTimer / 60)}:{(lockTimer % 60).toString().padStart(2, "0")} minutes.</span>
          </div>
        )}
        ...
        <div className="mb-6">
          <div className="grid grid-cols-3 gap-2 mb-6">
            <button
              ...
              className={`px-3 py-2 rounded-lg text-sm font-medium transition ${loginMethod === "google"
            ...
            <button
              ...
              className={`px-3 py-2 rounded-lg text-sm font-medium transition ${loginMethod === "email"
                ? "bg-gradient-to-r from-purple-600 to-blue-600 text-white"
                : "bg-gray-700/50 text-gray-400 hover:bg-gray-700"
                }`}
            >
            ...
            <button
              ...
              className={`px-3 py-2 rounded-lg text-sm font-medium transition ${loginMethod === "guest"
                ? "bg-gradient-to-r from-purple-600 to-blue-600 text-white"
                : "bg-gray-700/50 text-gray-400 hover:bg-gray-700"
                }`}
            >
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 pr-10 bg-gray-700/50 border-gray-600"
                    disabled={isLocked}
                  />
                  <button
                    type="button"
          ...
          {loginMethod === "guest" && (
            ...
            >
              <div className="text-center mb-4">
                <div className="bg-gray-700/30 p-4 rounded-full inline-block mb-3">
